...
using Npgsql;
using TaskStatus = AccountingSystem.Domain.Enums.TaskStatus; // ✅ הוסף את זה!

namespace AccountingSystem.Infrastructure.Data;

public partial class AccountingDbContext : DbContext
{
    // ✅ רישום הEnums עם PostgreSQL - חייב להיות static constructor!
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Auditlog>(entity =>
        {
            ...
            entity.Property(e => e.Entitytype).HasMaxLength(50).HasColumnName("entitytype");
            ...
            entity.Property(e => e.Createdat).HasColumnType("timestamp without time zone").HasColumnName("createdat").HasDefaultValueSql("CURRENT_TIMESTAMP");
            entity.HasOne(d => d.Worker).WithMany(p => p.Auditlogs).HasForeignKey(d => d.Workerid).HasConstraintName("fk_audit_worker");
        });
        ...
        modelBuilder.Entity<Company>(entity =>
        {
            ...
            entity.Property(e => e.Createdat).HasColumnType("timestamp without time zone").HasColumnName("createdat").HasDefaultValueSql("CURRENT_TIMESTAMP");
            entity.Property(e => e.Updatedat).HasColumnType("timestamp without time zone").HasColumnName("updatedat").HasDefaultValueSql("CURRENT_TIMESTAMP");
            entity.HasOne(d => d.Firm).WithMany(p => p.Companies).HasForeignKey(d => d.Firmid).HasConstraintName("fk_company_firm");
        });
        ...
        modelBuilder.Entity<Companycontact>(entity =>
        {
            ...
            entity.Property(e => e.Createdat).HasColumnType("timestamp without time zone").HasColumnName("createdat").HasDefaultValueSql("CURRENT_TIMESTAMP");
            entity.Property(e => e.Updatedat).HasColumnType("timestamp without time zone").HasColumnName("updatedat").HasDefaultValueSql("CURRENT_TIMESTAMP");
            entity.HasOne(d => d.Company).WithMany(p => p.Companycontacts).HasForeignKey(d => d.Companyid).HasConstraintName("fk_contact_company");
        });
        ...
        modelBuilder.Entity<Companyreportconfig>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.Companyid, e.Reporttypeid }).IsUnique().HasDatabaseName("uq_company_report");
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.Companyid).HasColumnName("companyid");
            ...
            entity.Property(e => e.Createdat).HasColumnType("timestamp without time zone").HasColumnName("createdat").HasDefaultValueSql("CURRENT_TIMESTAMP");
            entity.Property(e => e.Updatedat).HasColumnType("timestamp without time zone").HasColumnName("updatedat").HasDefaultValueSql("CURRENT_TIMESTAMP");
            entity.HasOne(d => d.Company).WithMany(p => p.Companyreportconfigs).HasForeignKey(d => d.Companyid).HasConstraintName("fk_config_company");
            entity.HasOne(d => d.Frequency).WithMany(p => p.Companyreportconfigs).HasForeignKey(d => d.Frequencyid).OnDelete(DeleteBehavior.Restrict).HasConstraintName("fk_config_frequency");
            entity.HasOne(d => d.Reporttype).WithMany(p => p.Companyreportconfigs).HasForeignKey(d => d.Reporttypeid).OnDelete(DeleteBehavior.Restrict).HasConstraintName("fk_config_reporttype");
        });
        ...
        modelBuilder.Entity<Companyworker>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.Companyid, e.Workerid }).IsUnique().HasDatabaseName("uq_company_worker");
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.Companyid).HasColumnName("companyid");
            entity.Property(e => e.Workerid).HasColumnName("workerid");
            entity.Property(e => e.Isactive).HasColumnName("isactive").HasDefaultValue(true);
            entity.Property(e => e.Assignedat).HasColumnType("timestamp without time zone").HasColumnName("assignedat").HasDefaultValueSql("CURRENT_TIMESTAMP");
            entity.HasOne(d => d.Company).WithMany(p => p.Companyworkers).HasForeignKey(d => d.Companyid).HasConstraintName("fk_companyworker_company");
            entity.HasOne(d => d.Worker).WithMany(p => p.Companyworkers).HasForeignKey(d => d.Workerid).HasConstraintName("fk_companyworker_worker");
        });
        ...
        // ✅ Reportinstance Configuration - עם string conversion!
        modelBuilder.Entity<Reportinstance>(entity =>
        {
            ...
            entity.HasOne(d => d.Config).WithMany(p => p.Reportinstances).HasForeignKey(d => d.Configid).HasConstraintName("fk_instance_config");
        });
        ...
        modelBuilder.Entity<Reporttype>(entity =>
        {
            ...
            entity.Property(e => e.Shortcode).HasMaxLength(20).HasColumnName("shortcode");
            entity.Property(e => e.Description).HasColumnName("description");
            entity.Property(e => e.Officialurl).HasMaxLength(255).HasColumnName("officialurl");
            entity.Property(e => e.Createdat).HasColumnType("timestamp without time zone").HasColumnName("createdat").HasDefaultValueSql("CURRENT_TIMESTAMP");
        });
        ...
        modelBuilder.Entity<AccountingSystem.Domain.Entities.Task>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.Companyid, e.Tasktypeid, e.Period }).IsUnique().HasDatabaseName("uq_task_period");
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.Companyid).HasColumnName("companyid");
            ...
            entity.Property(e => e.Createdat).HasColumnType("timestamp without time zone").HasColumnName("createdat").HasDefaultValueSql("CURRENT_TIMESTAMP");
            entity.Property(e => e.Updatedat).HasColumnType("timestamp without time zone").HasColumnName("updatedat").HasDefaultValueSql("CURRENT_TIMESTAMP");
            entity.HasOne(d => d.Assignedworker).WithMany(p => p.Tasks).HasForeignKey(d => d.Assignedworkerid).OnDelete(DeleteBehavior.SetNull).HasConstraintName("fk_task_worker");
            entity.HasOne(d => d.Company).WithMany(p => p.Tasks).HasForeignKey(d => d.Companyid).HasConstraintName("fk_task_company");
            entity.HasOne(d => d.Tasktype).WithMany(p => p.Tasks).HasForeignKey(d => d.Tasktypeid).OnDelete(DeleteBehavior.Restrict).HasConstraintName("fk_task_tasktype");
        });
        ...
        modelBuilder.Entity<Tasktype>(entity =>
        {
            ...
            entity.Property(e => e.Defaultorder).HasColumnName("defaultorder").HasDefaultValue(99);
            entity.Property(e => e.Createdat).HasColumnType("timestamp without time zone").HasColumnName("createdat").HasDefaultValueSql("CURRENT_TIMESTAMP");
        });
        ...
        modelBuilder.Entity<Worker>(entity =>
        {
            ...
            entity.Property(e => e.Email).HasMaxLength(255).HasColumnName("email");
            entity.Property(e => e.Phone).HasMaxLength(50).HasColumnName("phone");
            entity.Property(e => e.Employeeid).HasMaxLength(50).HasColumnName("employeeid");
            entity.Property(e => e.Isactive).HasColumnName("isactive").HasDefaultValue(true);
