...
////dataSourceBuilder.MapEnum<ReportStatus>("report_status", nameTranslator: nullNameTranslator);
////dataSourceBuilder.MapEnum<PaymentMethod>("payment_method", nameTranslator: nullNameTranslator);
...
//var dataSourceBuilder = new NpgsqlDataSourceBuilder(connectionString);
//dataSourceBuilder.MapEnum<TaskStatus1>("TaskStatus1", nameTranslator: nullNameTranslator);
//dataSourceBuilder.MapEnum<ReportStatus>("report_status", nameTranslator: nullNameTranslator);
//dataSourceBuilder.MapEnum<PaymentMethod>("payment_method", nameTranslator: nullNameTranslator);
//dataSourceBuilder.MapEnum<TaskCategory>("task_category", nameTranslator: nullNameTranslator);
//dataSourceBuilder.MapEnum<RecurrenceType>("recurrence_type", nameTranslator: nullNameTranslator);
//dataSourceBuilder.MapEnum<TaskPriority>("task_priority", nameTranslator: nullNameTranslator);
//var dataSource = dataSourceBuilder.Build();
